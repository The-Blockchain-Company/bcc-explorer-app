  ...
  <>
    {addresses?.filter(isDefined).map((io, index) => (
      <div className={styles.io}>
        ...
        {isEmpty(io.tokens) ? (
          <div className={styles.amount}>{io.value} BCC</div>
        ) : (
      ...
      <div className={styles.root}>
        ...
        {props.deposit !== '0' && (
          <div className={styles.row}>
            ...
            <div className={styles.value}>
              {Math.abs(parseInt(props.deposit))} BCC
            </div>
          </div>
        )}
        ...
        <div className={styles.row}>
          ...
          <div className={styles.value}>{props.totalOutput} BCC</div>
        </div>
        ...
        {props.showDetails && (
          <div className={styles.row}>
            ...
            <div className={styles.value}>{props.fee} BCC</div>
          </div>
        )}
