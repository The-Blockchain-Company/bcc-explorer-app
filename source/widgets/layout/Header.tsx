...
import { BrandType, BccEra, BccNetwork } from '../../constants';
...
import BccLogo from '../../public/assets/images/header/bcc-logo.svg';
...
export const Header = observer((props: IHeaderProps) => {
  ...
  const testnetSubtitle =
    environment.BCC.NETWORK !== BccNetwork.MAINNET ? (
      <div className={styles.networkTitle}>
        {environment.BCC.NETWORK.replace(/-/g, ' ')}
      </div>
    ) : null;
  const stakePoolLink =
      ...
      <div className={styles.contentContainer}>
        <div className={styles.brandType}>
          <div className={styles.logoContainer}>
            <LocalizedLink href="">
              <BccLogo className={styles.logo} />
            </LocalizedLink>
          </div>
          <div className={styles.titleContainer}>
            <LocalizedLink href="">
              <span className={styles.bccTitle}>Bcc</span>
